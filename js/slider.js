...
!(function (e, n) {
  ...
  e.fn.fullpage = function (Y) {
    function K(e) {
      e
        .find(F)
        .after('<div class="' + X + '"></div><div class="' + _ + '"></div>'),
        "#fff" != Y.controlArrowColor &&
          (e
            .find(G)
            .css(
              "border-color",
              "transparent transparent transparent " + Y.controlArrowColor
            ),
          e
            .find(j)
            .css(
              "border-color",
              "transparent " + Y.controlArrowColor + " transparent transparent"
            )),
        Y.loopHorizontal || e.find(j).hide();
    }
    function Q() {
      gn.append('<div id="' + A + '"><ul></ul></div>'),
        (yn = e(L)),
        yn.addClass(function () {
          return Y.showActiveTooltip
            ? B + " " + Y.navigationPosition
            : Y.navigationPosition;
        });
    ...
    function ee() {
      ...
      ne(n),
        we(n),
        ye(n),
        e.isFunction(Y.afterLoad) &&
          Y.afterLoad.call(n, n.data("anchor"), n.index(y) + 1),
        e.isFunction(Y.afterRender) && Y.afterRender.call(this);
    }
    function ne(e) {
      ...
      if (!Y.autoScrolling || Y.scrollBar) {
        if (!n.hasClass(g)) {
          ...
          En &&
            ...
            e.isFunction(Y.onLeave) && Y.onLeave.call(f, u, v, h),
            e.isFunction(Y.afterLoad) && Y.afterLoad.call(n, p, v),
            we(n),
            Fe(p, v - 1),
            Y.anchors.length && ((Sn = p), $e(w, S, p, v))),
            clearTimeout(zn),
    ...
    function ie(e, n) {
      if (Mn.m[e]) {
        ...
        if (
          ("down" == e
            ? ((o = "bottom"), (t = mn.moveSectionDown))
            : ((o = "top"), (t = mn.moveSectionUp)),
          n.length > 0)
        ) {
          if (!He(o, n)) return !0;
          t();
    ...
    function ae(n) {
      ...
      if (!se(n.target) && le(o)) {
        ...
        if (En && !bn) {
          ...
          (Dn = s.y),
            (Vn = s.x),
            i.find(F).length && t.abs(Hn - Vn) > t.abs(Fn - Dn)
              ? t.abs(Hn - Vn) > (J.width() / 100) * Y.touchSensitivity &&
                (Hn > Vn
                  ? Mn.m.right && mn.moveSlideRight()
                  : Mn.m.left && mn.moveSlideLeft())
              : Y.autoScrolling &&
                t.abs(Fn - Dn) > (J.height() / 100) * Y.touchSensitivity &&
                (Fn > Dn ? ie("down", a) : Dn > Fn && ie("up", a));
        }
      }
    }
    function se(n, o) {
      o = o || 0;
      var t = e(n).parent();
      return o < Y.normalScrollElementTouchThreshold &&
        t.is(Y.normalScrollElements)
        ? !0
        : o == Y.normalScrollElementTouchThreshold
        ? !1
        : se(t, ++o);
    }
    function le(e) {
    ...
    function he(n, o, t) {
      ...
      if ("undefined" != typeof i) {
        ...
        if (
          !(
            (a.activeSection.is(n) && !Ln) ||
            (Y.scrollBar && J.scrollTop() === a.dtop)
          )
        ) {
          ...
          if (
            (Y.autoScrolling &&
              ...
              (a = ge(a)),
            e.isFunction(Y.onLeave) && !a.localIsResizing)
          ) {
            if (
              Y.onLeave.call(
                a.activeSection,
          ...
          n.addClass(g).siblings().removeClass(g),
            (En = !1),
            $e(l, s, a.anchorLink, a.sectionIndex),
            pe(a),
            (Sn = a.anchorLink),
            Fe(a.anchorLink, a.sectionIndex);
        }
      }
    }
    function pe(n) {
      if (Y.css3 && Y.autoScrolling && !Y.scrollBar) {
        ...
        var t = ve(n);
        e(t.element)
          .animate(t.options, Y.scrollingSpeed, Y.easing)
          .promise()
          .done(function () {
            Se(n);
          });
    ...
    function Se(n) {
      me(n),
        ...
        e.isFunction(Y.afterLoad) &&
          !n.localIsResizing &&
          Y.afterLoad.call(n.element, n.anchorLink, n.sectionIndex + 1),
        we(n.element),
        ye(n.element),
        (En = !0),
    ...
    function we(n) {
      n.find("img[data-src], video[data-src], audio[data-src]").each(
        function () {
    ...
    function Le(n, o) {
      ...
      if (Y.onSlideLeave) {
        ...
        if (
          ...
          Y.onSlideLeave.call(u, r, l + 1, h, p, a) === !1
        )
          return void (bn = !1);
      }
      o.addClass(g).siblings().removeClass(g),
        !Y.loopHorizontal &&
          Y.controlArrows &&
          (s.find(j).toggle(0 !== a), s.find(G).toggle(!o.is(":last-child"))),
        s.hasClass(g) && $e(a, d, r, l);
      var v = function () {
        f ||
          (e.isFunction(Y.afterSlideLoad) &&
            Y.afterSlideLoad.call(o, r, l + 1, d, a)),
          (bn = !1);
      };
      if (Y.css3) {
        var S = "translate3d(-" + t.round(i.left) + "px, 0px, 0px)";
        Me(n.find(D), Y.scrollingSpeed > 0).css(cn(S)),
          setTimeout(
            function () {
              v();
            },
    ...
    function Me(e) {
      ...
      return (
        e.removeClass(u), e.css({ "-webkit-transition": n, transition: n })
      );
    }
    function Re(e) {
      return e.addClass(u);
    ...
    function Ie(n, o) {
      Y.navigation &&
        (e(L).find(m).removeClass(g),
        n
          ? e(L)
              .find('a[href="#' + n + '"]')
              .addClass(g)
          : e(L).find("li").eq(o).find("a").addClass(g));
    }
    function Pe(n) {
      Y.menu &&
        (e(Y.menu).find(m).removeClass(g),
        e(Y.menu)
    ...
    function qe(e) {
      ...
      t.length
        ...
        : ((n = e.get(0).scrollHeight),
          Y.verticalCentered && (n = e.find(k).get(0).scrollHeight));
      var i =
        An - parseInt(o.css("padding-bottom")) - parseInt(o.css("padding-top"));
      n > i
        ? t.length
          ? t
              .css("height", i + "px")
              ...
              .css("height", i + "px")
          : (Y.verticalCentered
              ? e.find(k).wrapInner('<div class="' + l + '" />')
    ...
    function Ue(e) {
      e.addClass(V).wrapInner(
        '<div class="' + C + '" style="height:' + Ye(e) + 'px;" />'
      );
    }
    function Ye(e) {
      var n = An;
    ...
    function Je() {
      var n = e(x),
        ...
        a = n.index(y),
        s = String(a);
      Y.anchors.length && (s = t),
        o.length && (s = s + "-" + i),
        (s = s.replace("/", "-").replace("#", ""));
      var l = new RegExp("\\b\\s?" + v + "-[^\\s]+\\b", "g");
      (gn[0].className = gn[0].className.replace(l, "")),
        gn.addClass(v + "-" + s);
    }
    function Ze() {
      var e,
    ...
    function en() {
      o.addEventListener
        ? (o.removeEventListener("mousewheel", de, !1),
          o.removeEventListener("wheel", de, !1),
          o.removeEventListener("DOMMouseScroll", de, !1))
        : o.detachEvent("onmousewheel", de);
    }
    function nn() {
      o.addEventListener
        ? (o.addEventListener("mousewheel", de, !1),
          o.addEventListener("wheel", de, !1),
          o.addEventListener("DOMMouseScroll", de, !1))
        : o.attachEvent("onmousewheel", de);
    }
    function on() {
      if (Tn || Cn) {
        var n = an();
        e(s)
          ...
          .on("touchstart " + n.down, re),
          e(s)
            .off("touchmove " + n.move)
            .on("touchmove " + n.move, ae);
      }
    }
    function tn() {
      if (Tn || Cn) {
      ...
      return (
        ...
        (n.x =
          "undefined" != typeof e.pageX && (e.pageY || e.pageX)
            ? e.pageX
            : e.touches[0].pageX),
        Cn && le(e) && ((n.y = e.touches[0].pageY), (n.x = e.touches[0].pageX)),
        n
      );
    }
    function ln(e, n) {
      mn.setScrollingSpeed(0, "internal"),
        "undefined" != typeof n && (Ln = !0),
        Le(e.closest(F), e),
        "undefined" != typeof n && (Ln = !1),
        mn.setScrollingSpeed(Rn.scrollingSpeed, "internal");
    }
    function rn(e) {
    ...
    (Y = e.extend(
      ...
      (mn.setAutoScrolling = function (n, o) {
        ...
        var t = e(x);
        Y.autoScrolling && !Y.scrollBar
          ? (vn.css({ overflow: "hidden", height: "100%" }),
            mn.setRecordHistory(Y.recordHistory, "internal"),
            kn.css({ "-ms-touch-action": "none", "touch-action": "none" }),
            t.length && rn(t.position().top))
          : (vn.css({ overflow: "visible", height: "initial" }),
            mn.setRecordHistory(!1, "internal"),
            kn.css({ "-ms-touch-action": "", "touch-action": "" }),
            rn(0),
            t.length && vn.scrollTop(t.position().top));
      }),
      ...
      (mn.setAllowScrolling = function (n, o) {
        "undefined" != typeof o
          ...
          : n
          ? (mn.setMouseWheelScrolling(!0), on())
          : (mn.setMouseWheelScrolling(!1), tn());
      }),
      ...
      (mn.moveSectionUp = function () {
        var n = e(x).prev(y);
        n.length || (!Y.loopTop && !Y.continuousVertical) || (n = e(y).last()),
          n.length && he(n, null, !0);
      }),
      (mn.moveSectionDown = function () {
        var n = e(x).next(y);
        if (
          (n.length ||
            (!Y.loopBottom && !Y.continuousVertical) ||
            (n = e(y).first()),
          n.length)
        ) {
          if (
            Y.onBeforeMoveSection &&
            e.isFunction(Y.onBeforeMoveSection) &&
            Y.onBeforeMoveSection.call(
              this,
              direction,
              currentSlide,
              destiny,
          ...
          (An = J.height()),
            ...
            e(y).each(function () {
              ...
              Y.verticalCentered &&
                e(this)
                  .find(k)
                  .css("height", Ye(e(this)) + "px"),
                e(this).css("height", An + "px"),
                Y.scrollOverflow &&
                  (o.length
                    ? o.each(function () {
                        qe(e(this));
                    ...
                    : qe(e(this))),
                o.length > 1 && Le(n, n.find(I));
            });
          var t = e(x),
            i = t.index(y);
          i && mn.silentMoveTo(i + 1),
            (Ln = !1),
            e.isFunction(Y.afterResize) && n && Y.afterResize.call(kn),
      ...
      (mn.setResponsive = function (n) {
        ...
        n
          ? o ||
            (mn.setAutoScrolling(!1, "internal"),
            mn.setFitToSection(!1, "internal"),
            e(L).hide(),
            kn.addClass(f))
          : o &&
            (mn.setAutoScrolling(Rn.autoScrolling, "internal"),
            mn.setFitToSection(Rn.autoScrolling, "internal"),
            e(L).show(),
            kn.removeClass(f));
      });
    var Sn,
      ...
      Bn = [],
      Mn = {};
    (Mn.m = { up: !0, down: !0, left: !0, right: !0 }),
      (Mn.k = e.extend(!0, {}, Mn.m));
    var Rn = e.extend(!0, {}, Y);
    e(this).length
      ? (kn.css({ height: "100%", position: "relative" }),
        kn.addClass(a),
        e("html").addClass(p))
      : pn(
          "error",
      ...
      Y.css3 && (Y.css3 = Ze()),
      mn.setAllowScrolling(!0),
      kn.removeClass(h),
      e(Y.sectionSelector).each(function () {
        e(this).addClass(w);
      }),
      ...
      e(y)
        .each(function (n) {
          var o = e(this),
            ...
            i = t.length;
          if (
            (n || 0 !== e(x).length || e(this).addClass(g),
            e(this).css("height", An + "px"),
            Y.paddingTop && e(this).css("padding-top", Y.paddingTop),
            Y.paddingBottom && e(this).css("padding-bottom", Y.paddingBottom),
            "undefined" != typeof Y.sectionsColor[n] &&
              e(this).css("background-color", Y.sectionsColor[n]),
            "undefined" != typeof Y.anchors[n] &&
              (e(this).attr("data-anchor", Y.anchors[n]),
              e(this).hasClass(g) && Fe(Y.anchors[n], n)),
            i > 0)
          ) {
            var a = 100 * i,
              s = 100 / i;
            t.wrapAll('<div class="' + H + '" />'),
              t.parent().wrap('<div class="' + P + '" />'),
              e(this)
                .find(D)
                .css("width", a + "%"),
              i > 1 &&
                (Y.controlArrows && K(e(this)),
                Y.slidesNavigation && Qe(e(this), i)),
              t.each(function (n) {
                e(this).css("width", s + "%"),
                  Y.verticalCentered && Ue(e(this));
              });
            var l = o.find(I);
        ...
        .done(function () {
          ...
          if (
            (t.length &&
              (0 !== e(x).index(y) ||
                (0 === e(x).index(y) && 0 !== t.index())) &&
              ln(t),
            Y.fixedElements && Y.css3 && e(Y.fixedElements).appendTo(gn),
            Y.navigation &&
              (yn.css("margin-top", "-" + yn.height() / 2 + "px"),
              yn.find("li").eq(e(x).index(y)).find("a").addClass(g)),
            Y.menu &&
              Y.css3 &&
              e(Y.menu).closest(s).length &&
              e(Y.menu).appendTo(gn),
            Y.scrollOverflow
              ? ("complete" === o.readyState && $(), J.on("load", $))
              : ee(),
            Be(),
            !Y.animateAnchor)
          ) {
            ...
            if (a.length) {
              ...
              l.length &&
                (Y.autoScrolling
                  ? rn(l.position().top)
                  : (rn(0), vn.scrollTop(l.position().top)),
                Fe(a, null),
                e.isFunction(Y.afterLoad) &&
                  Y.afterLoad.call(l, a, l.index(y) + 1),
                l.addClass(g).siblings().removeClass(g));
            }
          }
          Je(),
            J.on("load", function () {
    ...
    Z.on("click touchstart", L + " a", function (n) {
      ...
      Y.normalScrollElements &&
        (Z.on("mouseenter", Y.normalScrollElements, function () {
    ...
    mn.destroy = function (n) {
      mn.setAutoScrolling(!1, "internal"),
        mn.setAllowScrolling(!1),
        mn.setKeyboardScrolling(!1),
        kn.addClass(h),
        J.off("scroll", oe).off("hashchange", Te).off("resize", Ee),
        Z.off("click", L + " a")
          .off("mouseenter", L + " li")
          .off("mouseleave", L + " li")
          .off("click", U)
 ...
 */ !(function (e, t, n, o, i) {
  e.fn.multiscroll = function (s) {
    ...
    function u() {
      s.css3
        ? (S(
            e(".ms-left"),
            "translate3d(0px, -" +
              e(".ms-left").find(".ms-section.active").position().top +
              "px, 0px)",
            !1
          ),
          S(
            e(".ms-right"),
            "translate3d(0px, -" +
              e(".ms-right").find(".ms-section.active").position().top +
              "px, 0px)",
            !1
          ))
        : (e(".ms-left").css(
    ...
    function h() {
      n.addEventListener
        ? (n.removeEventListener("mousewheel", g, !1),
          n.removeEventListener("wheel", g, !1))
        : n.detachEvent("onmousewheel", g);
    }
    function p() {
      n.addEventListener
        ? (n.addEventListener("mousewheel", g, !1),
          n.addEventListener("wheel", g, !1))
        : n.attachEvent("onmousewheel", g);
    }
    function g(e) {
      e = t.event || e;
    ...
    function x(t, n) {
      s.navigation &&
        (e("#multiscroll-nav").find(".active").removeClass("active"),
        t
          ? e("#multiscroll-nav")
              .find('a[href="#' + t + '"]')
              .addClass("active")
    ...
    function w(t) {
      s.menu &&
        (e(s.menu).find(".active").removeClass("active"),
        e(s.menu)
    ...
    function M(e) {
      e.addClass("ms-table").wrapInner(
        '<div class="ms-tableCell" style="height: ' + P(e) + 'px" />'
      );
    }
    function P(e) {
      var t = N;
    ...
    function L(n) {
      ...
      if (D(i)) {
        ...
        if (!K) {
          ...
          (A = a.y),
            (V = a.x),
            o.abs(Q - A) > (e(t).height() / 100) * s.touchSensitivity &&
              (Q > A ? X.moveSectionDown() : A > Q && X.moveSectionUp());
        }
      }
    }
    function D(e) {
    ...
    function B() {
      I &&
        ...
        e(n)
          ...
          .on("touchstart " + MSPointer.down, z),
        e(n)
          .off("touchmove " + MSPointer.move)
          .on("touchmove " + MSPointer.move, L));
    }
    function R() {
      I &&
        ((MSPointer = Y()),
      ...
      return (
        ...
        (t.x =
          "undefined" != typeof e.pageX && (e.pageY || e.pageX)
            ? e.pageX
            : e.touches[0].pageX),
        I && D(e) && ((t.y = e.touches[0].pageY), (t.x = e.touches[0].pageX)),
        t
      );
    }
    ...
    var U,
      W = e(".ms-left").find(".ms-section").length,
      K = !1,
      N = e(t).height();
    p(),
      B(),
      s.css3 && (s.css3 = E()),
      e("html, body").css({ overflow: "hidden", height: "100%" }),
      ".ms-section" !== s.sectionSelector &&
        e(s.sectionSelector).each(function () {
          e(this).addClass("ms-section");
        }),
      s.navigation &&
        (e("body").append('<div id="multiscroll-nav"><ul></ul></div>'),
        (U = e("#multiscroll-nav")),
      ...
      e(".ms-left .ms-section, .ms-right .ms-section").each(function () {
        ...
        if (
          ...
          "undefined" != typeof s.sectionsColor[t] &&
            e(this).css("background-color", s.sectionsColor[t]),
          "undefined" != typeof s.anchors[t] &&
            e(this).attr("data-anchor", s.anchors[t]),
      ...
      e(".ms-left .ms-section, .ms-right .ms-section")
        .each(function () {
          var t = e(this).index();
          e(this).css({ height: "100%" }),
            !t &&
              s.navigation &&
              U.find("li").eq(t).find("a").addClass("active");
        })
        .promise()
        .done(function () {
          e(".ms-left .ms-section.active").length ||
            (e(".ms-right").find(".ms-section").last().addClass("active"),
    ...
    e(n).mousedown(function (e) {
      ...
      e(n).on({ mouseenter: m, mouseleave: f }, "#multiscroll-nav li"),
      s.normalScrollElements &&
        (e(n).on("mouseenter", s.normalScrollElements, function () {
      ...
      (X.moveTo = function (t) {
        var n = "";
        (n = isNaN(t)
          ? e('.ms-left [data-anchor="' + t + '"]')
          : e(".ms-left .ms-section").eq(t - 1)),
          v(n);
      }),
    ...
    (X.destroy = function () {
      ...
      (X.build = function () {
        X.setKeyboardScrolling(!0),
          ...
          e(n)
            .on("mouseenter", "#multiscroll-nav li", m)
            .on("mouseleave", "#multiscroll-nav li", f)
